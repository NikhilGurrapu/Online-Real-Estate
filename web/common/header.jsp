  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
        ...
        <a class="navbar-brand" href="index.jsp"><img src="C:\Users\HP\OneDrive\Documents\NetBeansProjects\Project\web\img\ores logos\oresfinal2.png"
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    &nbsp;&nbsp;<b style="text-transform: uppercase; font-weight: normal;"><%= sb.getName()%></b>
                    ...
                    %>
                     ...
                     %>
                          ...
                          <ul class="nav navbar-nav navbar-right">
                              <li><a href="user/search.jsp"><span class="glyphicon glyphicon-search"></span>&nbsp;Search</a></li>
                              <li><a href="user/contact.jsp">CONTACT</a></li>
                              <li><a href="user/faq.jsp">FAQs</a><li>
                          </ul>
                     <%
                        }
                        }

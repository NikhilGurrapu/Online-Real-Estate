  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
        ...
        <a class="navbar-brand" href="index.jsp"><img src="C:\Users\HP\OneDrive\Documents\NetBeansProjects\Project\web\img\ores logos\oresadminfinal.png"
                                                      width="125" height="75" style="margin-top: -28px;"></a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Independent House/Villa</a></li>
            <li><a href="#">Independent/Builder Floor</a></li>
            <li><a href="#">Land</a></li>
        ...
        <li class="dropdown">
            ...
            <% 
                      if(sb.getRole().equals("admin")){
                          ...
                          <li><a class="dropdown-item" href="dashboard.jsp"><span class="glyphicon glyphicon-th-list"></span>&nbsp;&nbsp;&nbsp;&nbsp;DASHBOARD</a></li>
                          ...
                          <li><a class="dropdown-item" href="#"><span class="glyphicon glyphicon-king" style="font-size: 20px;"></span>&nbsp;&nbsp;&nbsp;&nbsp;MY PROPERTIES</a></li>
